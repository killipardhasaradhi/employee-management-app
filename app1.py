...
st.markdown("""
    ...
    /* Force every possible layer of the input to be dark with bright text,
       since different Streamlit/BaseWeb versions nest the visible box differently */
    input, textarea,
    ...
    /* Fix invisible text caused by mobile Chrome/browser autofill styling */
    ...
    /* Selected value text in dropdowns (company selector, etc.) */
    ...
    /* 6. Buttons - gradient primary, professional secondary
       ...
       which Streamlit renders with different "kind" values) */
...
# ---------------------------------------------------------
    ...
    # =========================================================
        ...
        host_nav = render_menu("host", ["HOME", "ATTENDANCE", "LOCATION", "STAFF", "NOTICES", "SETTINGS"])
    ...
    # =========================================================
        ...
        # Bottom Bar Navigation
        emp_nav = render_menu("emp", ["ATTEND", "GEOFENCE", "NOTICES", "PROFILE"])
